...
1/ on éxecute le projet en mettant la commande npm run build et on ouvre le fichier index.html du dossier dist 

2/tout les fonctions que j'ai effectué marchent juste un petit probleme quand je touche le oiseau il enlève plus que 500,et je vais essayé de le régler au plus vite possible.
